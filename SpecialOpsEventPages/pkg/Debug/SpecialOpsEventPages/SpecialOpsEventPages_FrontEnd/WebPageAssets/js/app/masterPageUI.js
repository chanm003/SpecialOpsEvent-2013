define(function (require) {
    ...
    function defineCustomActionsForRFIList() {
        window.customRfiActions = {
            openRfiResponseModal: function (itemId, listUrl) {
                window.location.href = _spPageContextInfo.webServerRelativeUrl + "/Lists/RFI/Respond.aspx?ID=" + itemId + "&Source=" + document.location.href;
            },
            openRfiInsufficientModal: function (itemId, listUrl) {
                window.location.href = _spPageContextInfo.webServerRelativeUrl + "/Lists/RFI/sufficient.aspx?ID=" + itemId + "&Source=" + document.location.href;
            }
        };
    ...
    function addBehaviorForRfiButtons() {
        $(".rfiBtn").on('click', function () {
            ...
            var listItemId = btn.attr("data-id");
